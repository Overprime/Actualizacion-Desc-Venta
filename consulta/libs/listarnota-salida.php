...
CASE WHEN RTRIM(MC.CAORDFAB)= '' THEN 'SIN O/F'
 eLSE ISNULL(MC.CAORDFAB , 'SIN O/F') END ORFAB  FROM [015BDCOMUN].DBO.MOVALMCAB  as MC INNER JOIN 
 [015BDCOMUN].DBO.INV_REQMATERIAL_CAB AS RMA 
ON  MC.CARFNDOC=RMA.REQ_NUMERO  INNER JOIN   [015BDCOMUN].DBO.INV_REQMATERIAL_DET  AS RMD ON 
