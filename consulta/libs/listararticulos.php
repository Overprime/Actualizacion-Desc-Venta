...
$link=  Conectarse();
$listado=  mssql_query("SELECT ACODIGO,ADESCRI,AFAMILIA,AUNIDAD,STSKDIS,
	SUM(ISNULL(CANT_PEND,0))AS CANT_RESEV,
(STSKDIS-SUM(ISNULL(CANT_PEND,0)))AS CANT_DISP,ACOMENTA 
FROM [015BDCOMUN].DBO.MAEART AS M INNER JOIN [015BDCOMUN].DBO.STKART AS S ON
...
<td><a href="detalle/articulos?codigo=<?php echo utf8_encode($reg['ACODIGO']); ?>&
