...
CODIGOOT,CONVERT(VARCHAR,FECHA,103) as FECHAS
FROM [020BDCOMUN].DBO.CENCOSOT AS CC INNER JOIN 
[015BDCONTABILIDAD].DBO.CENTRO_COSTOS AS CCC ON 
CC.CODIGOCENTROCOSTO=CCC.CENCOST_CODIGO  ORDER BY CENCOST_DESCRIPCION ",$link);
?>
