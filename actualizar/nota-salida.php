...
$Sql ="UPDATE  [015BDCOMUN].DBO.MOVALMDET SET DEORDFAB='$OF'
WHERE DENUMDOC='$DOCUMENTO' AND DETD='NS'  AND DEALMA='01' AND DEALMA='01' " ;

$Sql1="UPDATE [015BDCOMUN].DBO.MOVALMCAB SET CAORDFAB='$OF' 
...
window.location = "/overprime/compras/actualizacion-codigos/consulta/nota-salida";
</script>
